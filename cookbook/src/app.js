 ...
 * Date: June 25. 2026
 * File Name: app.js
 * Description: Server setup for the Cookbook API application.
 */
      ...
      <div class="container">
        ...
        <main>
          <div class="recipe">
            ...
            <p>1. Brown the ground beef in a skillet.<br>2. 
            Warm the taco shells in the oven.<br>3. Fill the taco 
            shells with beef, lettuce, and cheese.</p>
          </div>
          <div class="recipe">
            <h3>Vegetarian Lasagna</h3>
            <p>1. Layer lasagna noodles, marinara sauce, and cheese 
            in a bakingdish.<br>2. Bake at 375 degrees for 45 minutes.
            <br>3. Let cool beforeserving.</p>
          </div>
        </main>
      </div>
    </body>
